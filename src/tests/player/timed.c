...
static int test_set_timed4(void *state) {
	...
	struct {
		...
		{ 0, -1518, false, false, 0, false, NULL, NULL },
		...
		{ timed_effects[TMD_OPP_ACID].grade->next->max, 0, false, false, 0, false, NULL, NULL },
...
static int test_set_timed5(void *state) {
	...
	struct {
		...
		{ 0, -1122, false, false, 0, false, NULL, NULL },
		{ 0, -1, true, true, true, 0, false, NULL, NULL },
		...
		{ timed_effects[TMD_SINVIS].grade->next->max, 0, false, false, 0, false, NULL, NULL },
